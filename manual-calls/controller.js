import {
  ...
  export async function getToken(req, res) {
    try {
      ...
      return jsonError(res, 401, "Failed to generate manual calling token.", error);
    }
  }
  ...
  export async function outboundVoiceWebhook(req, res) {
    try {
      ...
      const twiml = buildOutboundTwiml({
        ...
        recordingStatusCallbackUrl: absoluteUrl(req, "/manual-calls/recording/status"),
      });
